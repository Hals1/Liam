...
optionM.addEventListener("click", function() {
	recap.classList.add('invisivel')
	mark.classList.remove('invisivel')
	mark.classList.remove('blur')
	mark.classList.add('no-blur')
});

//abre o "ficar em casa"
optionMa.addEventListener("click", function() {
	mark.classList.add('invisivel')
	titulo.classList.remove("invisivel");
	titulo.classList.remove("blur");
	titulo.classList.add("no-blur");
	rotaM1.classList.remove("invisivel");
	rotaM1.classList.remove("blur");
	rotaM1.classList.add("no-blur");
});
